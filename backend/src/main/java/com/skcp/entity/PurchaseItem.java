...
public class PurchaseItem
{
    ...
    public void prePersist()
    {
        ...
        /*
         * Every newly created PurchaseItem is ACTIVE
         * unless explicitly assigned otherwise by the
...
/*
For the PurchaseItem.java change we discussed, 
the goal is to prevent accidental deletion of a PurchaseItem when the parent Purchase is being manipulated, 
